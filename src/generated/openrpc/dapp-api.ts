 ...
 * Source ID: splice-dapp-api-openrpc
 * Upstream ref: 84e89330978979d4df8905bc67939b6473f23d1c
 * Artifact version: 0.5.0
 * Fetched at: 2026-04-02T20:11:16.928Z
 * SHA-256: b55b5b59353426e3aa98918a350f16e9d69da083dc88b2818292638bc023a2cb
 */
...
export const spliceDappApiOpenRpcMetadata = {
  ...
  "upstream": {
    ...
    "ref": "84e89330978979d4df8905bc67939b6473f23d1c",
    "repo": "https://github.com/hyperledger-labs/splice-wallet-kernel",
    "url": "https://raw.githubusercontent.com/hyperledger-labs/splice-wallet-kernel/84e89330978979d4df8905bc67939b6473f23d1c/api-specs/openrpc-dapp-api.json"
  },
...
export const spliceDappApiOpenRpcSpec: OpenRpcDocument = {
  "openrpc": "1.2.6",
  "info": {
  ...
  "methods": [
    ...
    },
    {
      ...
      "result": {
        "name": "result",
        "schema": {
          "$ref": "api-specs/openrpc-dapp-api.json#/components/schemas/Wallet"
        }
      },
  ...
  "components": {
    "schemas": {
      ...
      "LedgerApiResult": {
        ...
        "type": "object",
        "description": "Ledger Api response",
      ...
      "Wallet": {
        ...
        "properties": {
          ...
          "disabled": {
            "title": "disabled",
            "type": "boolean",
            "description": "Whether the wallet is disabled. Wallets are disabled when no signing provider matches the party's namespace during sync. Disabled wallets use participant as the default signing provider."
          },
          "reason": {
            "title": "reason",
            "type": "string",
            "description": "Reason for the wallet state, e.g., 'no signing provider matched'."
          }
        },
        "required": [
          "primary",
